...
class Browser:
    def __init__(self, has_screen):
        ...
        service_args = ["--ignore-ssl-errors=true"]  # Ignore any SSL error in the Path
        ...
        self.driver = webdriver.Chrome(
            ...
            service_args=service_args,  # List of args to pass to the driver service
            chrome_options=chrome_options,
        )
        self.driver.implicitly_wait(5)  # Selenium Waits for 5 Seconds until data is visible.

    @property
    def page_height(self):
        return self.driver.execute_script("return document.body.scrollHeight")  # Scroll till the height of page
